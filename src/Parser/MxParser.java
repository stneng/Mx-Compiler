...
public class MxParser extends Parser {
    ...
    public static class LiteralContext extends ParserRuleContext {
        ...
        public TerminalNode BoolLiteral() {
            return getToken(MxParser.BoolLiteral, 0);
        }

        public TerminalNode StrLiteral() {
            return getToken(MxParser.StrLiteral, 0);
        }
    ...
    public static class SimpleCreatorContext extends CreatorContext {
        ...
        public SimpleCreatorContext(CreatorContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class SubscriptExprContext extends ExpressionContext {
        ...
        public SubscriptExprContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class SuffixExprContext extends ExpressionContext {
        ...
        public SuffixExprContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
